...
Page({
  data: {
    ...
    menu: [
      ...
      { id: 'menu14', name: '离职/退休申请', imgUrl: '../../images/out.png', url: '../../efgp/pages/resign/resign', parentid: -1 },
      { id: 'menu15', name: '证明开具申请', imgUrl: '../../images/zheng.png', url: '../../efgp/pages/Issue/Issue', parentid: -1 }
    ],
    indicatorDots: false,
    autoplay: true,
    interval: 5000,
